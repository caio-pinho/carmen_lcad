...
//Subscribers
void carmen_neural_motion_planner_subscribe_motion_plan_message(carmen_neural_motion_planner_motion_plan_message *message, carmen_handler_t handler, carmen_subscribe_t subscribe_how);
...
//Publishers
void carmen_neural_motion_planner_publish_motion_plan_message(carmen_robot_and_trailer_traj_point_t *plan, int plan_length);
